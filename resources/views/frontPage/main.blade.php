...
<head>
    ...
    <link href="{{asset('mainpage/main-page.css')}}" rel="stylesheet">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto my-2 my-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger login-css" href="#joinus">Join Us</a>
                </li>
            </ul>
        </div>
    </div>
...
<section class="page-section bg-dark text-white" id="joinus">
    <div class="container text-center">
{{--        <h2 class="mb-4">Join Us As</h2>--}}
        <div class="row">
            <div class="col-md-6"><a class="btn btn-light btn-xl" href="{{url('admin/login')}}">Admin Login</a></div>
            <div class="col-md-6"><a class="btn btn-light btn-xl"  href="{{url('customer/login')}}">Customer login</a></div>
        </div>
    </div>
</section>
